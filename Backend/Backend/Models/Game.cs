...
namespace Backend.Models
{
    public class Game : IGame
    {
        ...
        public GameParticipant First { get; set; }
        public GameParticipant Second { get; set; }
        ...
        public Game(Player creater, string description = "I wanna play a game and don't have any requirements!")
        {
